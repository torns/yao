...
(
  `id`           varchar(255) NOT NULL COMMENT '数据源ID',
  `name`         varchar(50)       DEFAULT NULL COMMENT '数据源名称',
  `type`         varchar(128)      DEFAULT NULL COMMENT '数据源类型 mysql oracle',
...
(
  `id`           int(10)      NOT NULL AUTO_INCREMENT COMMENT '报表历史记录id',
  ...
  DEFAULT CHARSET = utf8 COMMENT ='报表历史记录表';
...
(
  ...
  DEFAULT CHARSET = utf8 COMMENT ='报表上传配置表';