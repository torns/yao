package com.y3tu.cloud.transaction.message.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.y3tu.cloud.common.exception.MessageExceptionEnum;
import com.y3tu.cloud.transaction.message.common.IOCUtil;
import com.y3tu.cloud.transaction.message.common.MessageStatusEnum;
import com.y3tu.cloud.transaction.message.common.PublicEnum;
import com.y3tu.cloud.transaction.message.dto.EventTypeEnum;
import com.y3tu.cloud.transaction.message.mapper.MessageLogMapper;
import com.y3tu.cloud.transaction.message.pojo.MessageLog;
import com.y3tu.cloud.transaction.message.service.IMessageEventHandler;
import com.y3tu.cloud.transaction.message.service.IMessageLogService;
...
public class MessageLogServiceImpl extends ServiceImpl<MessageLogMapper, MessageLog>
    ...
    private void checkEmptyMessage(MessageLog messageLog) {
        ...
        if (StringUtils.isEmpty(messageLog.getMessageId())) {
            throw new ServerException(MessageExceptionEnum.MESSAGE_ID_CANT_EMPTY.getMessage());
        }
        if (StringUtils.isEmpty(messageLog.getMessageBody())) {
            throw new ServerException(MessageExceptionEnum.MESSAGE_BODY_CANT_EMPTY.getMessage());
        }
