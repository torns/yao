...
import com.y3tu.cloud.upms.dao.SysRoleDeptMapper;
import com.y3tu.cloud.upms.dao.SysRoleMapper;
import com.y3tu.cloud.upms.model.dto.RoleDTO;
import com.y3tu.cloud.upms.model.entity.SysRole;
import com.y3tu.cloud.upms.model.entity.SysRoleDept;
...
public class SysRoleServiceImpl extends ServiceImpl<SysRoleMapper, SysRole> implements SysRoleService {
    ...
    public Page selectwithDeptPage(Query<Object> query, EntityWrapper<Object> wrapper) {
        query.getPage().setRecords(sysRoleMapper.selectRolePage(query, query.getPage().getCondition()));
