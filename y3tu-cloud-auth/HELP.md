...
| 服务名                     |   简介         |  默认地址                |
|---------------------------|----------------|-------------------------|
| authorization-server      | 授权服务        |  http://localhost:9003  |
| authentication-server     | 签权服务        |  http://localhost:9002  |
...
![网关架构](https://github.com/zhoutaoo/SpringCloud/blob/master/docs/auth.png?raw=true)
