package com.y3tu.cloud.auth.client.service.impl;

import com.y3tu.cloud.auth.client.provider.AuthProvider;
...
public class AuthServiceImpl implements IAuthService {
    ...
    public boolean hasPermission(R authResult) {
        return authResult.get("code").equals("200") && (boolean) authResult.get("data");
    }
