...
import com.y3tu.cloud.auth.authentication.feign.fallback.UserServiceFallback;
 ...
 * </p>
 */
@FeignClient(name = ServiceNameConstants.UPMS_SERVER, fallback = UserServiceFallback.class)
