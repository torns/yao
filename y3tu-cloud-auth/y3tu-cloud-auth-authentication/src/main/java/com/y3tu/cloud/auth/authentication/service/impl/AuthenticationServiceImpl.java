...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    public boolean decide(HttpServletRequest authRequest) {
        ...
        //获取此访问用户所有角色拥有的权限资源
        List<ResourcesVO> userResources = findResourcesByAuthorityRoles(authentication.getAuthorities());
     ...
     * @return
     */
    public boolean isMatch(ConfigAttribute urlConfigAttribute, List<ResourcesVO> userResources) {
     ...
     * @return
     */
    private List<ResourcesVO> findResourcesByAuthorityRoles(Collection<? extends GrantedAuthority> authorityRoles) {
        //用户被授予的角色
