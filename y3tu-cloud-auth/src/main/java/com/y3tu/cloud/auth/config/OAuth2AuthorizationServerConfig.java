...
import com.y3tu.cloud.auth.handler.CustomWebResponseExceptionTranslator;
import com.y3tu.cloud.auth.security.UserDetailsImpl;
    ...
    public TokenEnhancer tokenEnhancer() {
        return new TokenEnhancer() {
            ...
            public OAuth2AccessToken enhance(OAuth2AccessToken oAuth2AccessToken, OAuth2Authentication oAuth2Authentication) {
                ...
                rabbitTemplate.convertAndSend(MqQueueNameConstants.SYS_LOG_QUEUE, sysLogDTO);
                log.info("当前用户为：{}", user);
