...
import com.y3tu.cloud.auth.mobile.MobileAuthenticationFilter;
import com.y3tu.cloud.auth.mobile.MobileAuthenticationProvider;
import com.y3tu.cloud.auth.security.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    private FilterIgnorePropertiesConfig ignoreUrlPropertiesConfig;
