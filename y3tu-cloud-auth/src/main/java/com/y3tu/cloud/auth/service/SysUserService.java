...
import com.y3tu.cloud.auth.service.fallback.SysUserServiceFallback;
 ...
 * </p>
 */
@FeignClient(name = "upms-service", fallback = SysUserServiceFallback.class, configuration = SysUserService.UserFeignConfig.class)
