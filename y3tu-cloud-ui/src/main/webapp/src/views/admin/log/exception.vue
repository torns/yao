<template>
    <div>
        <div class="search-container">
            <el-input v-if="sys_log_exception_select" placeholder="请输入模块名称" v-model="table.query.moduleName"
                      style="width:200px" @keyup.enter.native="getData" clearable/>
            <el-button v-if="sys_log_exception_select" class="search-btn" type="primary" icon="el-icon-search"
                       @click="getData">查询
            </el-button>
