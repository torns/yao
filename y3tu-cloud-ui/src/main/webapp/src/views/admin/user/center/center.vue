        ...
        <el-row :gutter="20">
            <el-col :xs="24" :sm="24" :md="8" :lg="6" :xl="5">
                <el-card class="box-card">
                    ...
                    <div>
                        ...
                        <ul class="user-info">
                            <li>
                                <icon name="user" style="margin-right: 8px"/>
                                用户名称
                                <div class="user-right">{{ user.username }}</div>
                            </li>
                            <li>
                                <icon name="phone" style="margin-right: 8px"/>
                                手机号码
                                <div class="user-right">{{ user.mobile }}</div>
                            </li>
                            <li>
                                <icon name="envelope" style="margin-right: 8px"/>
                                用户邮箱
                                <div class="user-right">{{ user.email }}</div>
                            </li>
                            <li>
                                <icon name="users" style="margin-right: 8px"/>
                                所属部门
                                <div class="user-right"> {{ user.departmentName }}</div>
                            </li>
                            <li>
                                <icon name="history" style="margin-right: 8px"/>
                                创建日期
            ...
            <el-col :xs="24" :sm="24" :md="16" :lg="18" :xl="19">
                <el-card class="box-card">
                    <div slot="header" class="clearfix">
                        <span>操作日志</span>
                        <div style="display:inline-block;float: right;cursor: pointer" @click="refresh"><i
                                :class="ico"/></div>
                    </div>
                    <log ref="log"/>
                </el-card>
