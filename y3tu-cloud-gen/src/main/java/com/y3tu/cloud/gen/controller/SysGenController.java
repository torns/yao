...
public class SysGenController {
    ...
    @SysLog(serviceId = ServiceNameConstants.GEN_SERVICE, moduleName = MODULE_NAME, actionName = "分页查询数据库中所有的表信息")
    ...
    @SysLog(serviceId = ServiceNameConstants.GEN_SERVICE, moduleName = MODULE_NAME, actionName = "根据表名称生成代码  返回zip包")
