...
public class SysGenController {
    ...
    @Log(serviceId = ServerNameConstants.GEN_SERVER, moduleName = MODULE_NAME, actionName = "分页查询数据库中所有的表信息")
    ...
    @Log(serviceId = ServerNameConstants.GEN_SERVER, moduleName = MODULE_NAME, actionName = "根据表名称生成代码  返回zip包")
