<template>
    <div>
        <div class="search-container">
            ...
            <el-button v-if="sys_gen_select" class="search-btn" type="primary" icon="el-icon-search" @click="getData">
                查询
            </el-button>
        ...
        <el-table v-loading="table.loading" :data="table.data" @selection-change="selectChangeHandle" border
        ...
        <el-dialog title="代码生成配置" :visible.sync="dialogShow" width="600px" :close-on-click-modal="false">
            <el-form ref="roleForm" :model="table.param" label-width="140px" label-position="right">
                ...
                <el-form-item label="controller包名称" prop="controllerPackageName"
                              v-if="table.param.genType == 'mybatis'">
